...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mybioregions_drawnbioregion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mybioregions_drawnbioregion_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mybioregions_drawnbioregion_related', null=True, to=orm['contenttypes.ContentType'])),
        ...
        db.send_create_signal('mybioregions', ['DrawnBioregion'])

        # Adding M2M table for field sharing_groups on 'DrawnBioregion'
        db.create_table('mybioregions_drawnbioregion_sharing_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('drawnbioregion', models.ForeignKey(orm['mybioregions.drawnbioregion'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('mybioregions_drawnbioregion_sharing_groups', ['drawnbioregion_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('mybioregions_placeholder', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mybioregions_placeholder_related', null=True, to=orm['contenttypes.ContentType'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geometry_orig', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=54009, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.delete_table('mybioregions_drawnbioregion')

        # Removing M2M table for field sharing_groups on 'DrawnBioregion'
        db.delete_table('mybioregions_drawnbioregion_sharing_groups')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 15, 9, 29, 886792)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 15, 9, 29, 886655)'}),
