...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyBioregion.input_bioregion_size'
        db.add_column('mybioregions_mybioregion', 'input_bioregion_size', self.gf('django.db.models.fields.FloatField')(default=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MyBioregion.input_bioregion_size'
        db.delete_column('mybioregions_mybioregion', 'input_bioregion_size')
    ...
    models = {
        ...
        'mybioregions.mybioregion': {
            ...
            'input_bioregion_size': ('django.db.models.fields.FloatField', [], {}),
