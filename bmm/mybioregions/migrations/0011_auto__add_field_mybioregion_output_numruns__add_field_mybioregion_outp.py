...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyBioregion.output_numruns'
        db.add_column('mybioregions_mybioregion', 'output_numruns', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MyBioregion.output_initcost'
        db.add_column('mybioregions_mybioregion', 'output_initcost', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'MyBioregion.output_finalcost'
        db.add_column('mybioregions_mybioregion', 'output_finalcost', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MyBioregion.output_numruns'
        db.delete_column('mybioregions_mybioregion', 'output_numruns')

        # Deleting field 'MyBioregion.output_initcost'
        db.delete_column('mybioregions_mybioregion', 'output_initcost')

        # Deleting field 'MyBioregion.output_finalcost'
        db.delete_column('mybioregions_mybioregion', 'output_finalcost')
