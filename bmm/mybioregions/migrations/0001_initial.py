...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mybioregions_mybioregion', (
            ...
            ('geometry_orig', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True)),
            ('geometry_final', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True)),
        ))
