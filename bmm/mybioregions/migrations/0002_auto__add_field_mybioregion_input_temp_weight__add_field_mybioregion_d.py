...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyBioregion.input_temp_weight'
        db.add_column('mybioregions_mybioregion', 'input_temp_weight', self.gf('django.db.models.fields.FloatField')(default=0.5), keep_default=False)

        # Adding field 'MyBioregion.description'
        db.add_column('mybioregions_mybioregion', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MyBioregion.input_temp_weight'
        db.delete_column('mybioregions_mybioregion', 'input_temp_weight')

        # Deleting field 'MyBioregion.description'
        db.delete_column('mybioregions_mybioregion', 'description')
