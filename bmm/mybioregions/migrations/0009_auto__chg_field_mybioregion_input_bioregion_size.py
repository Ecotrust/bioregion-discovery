...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MyBioregion.input_bioregion_size'
        db.alter_column('mybioregions_mybioregion', 'input_bioregion_size', self.gf('django.db.models.fields.CharField')(max_length=3))


    def backwards(self, orm):
        
        # Changing field 'MyBioregion.input_bioregion_size'
        db.alter_column('mybioregions_mybioregion', 'input_bioregion_size', self.gf('django.db.models.fields.FloatField')())
