...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StoryPoint.title'
        db.delete_column('mybioregions_storypoint', 'title')

        # Changing field 'StoryPoint.url'
        db.alter_column('mybioregions_storypoint', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Adding field 'StoryPoint.title'
        db.add_column('mybioregions_storypoint', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=140), keep_default=False)

        # Changing field 'StoryPoint.url'
        db.alter_column('mybioregions_storypoint', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 9, 44, 14, 192208)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 9, 44, 14, 192100)'}),
