...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BioregionShapefile'
        db.create_table('mybioregions_bioregionshapefile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=54009, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('bio_id_num', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mybioregions.Folder'], null=True, blank=True)),
            ...
            ('bioregion', self.gf('django.db.models.fields.related.OneToOneField')(related_name='bioregion', unique=True, to=orm['mybioregions.MyBioregion'])),
        ))
        db.send_create_signal('mybioregions', ['BioregionShapefile'])


    def backwards(self, orm):
        
        # Deleting model 'BioregionShapefile'
        db.delete_table('mybioregions_bioregionshapefile')
