...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyBioregion.satisfied'
        db.add_column('mybioregions_mybioregion', 'satisfied', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MyBioregion.satisfied'
        db.delete_column('mybioregions_mybioregion', 'satisfied')
