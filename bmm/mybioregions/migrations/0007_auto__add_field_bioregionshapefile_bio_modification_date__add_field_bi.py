...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BioregionShapefile.bio_modification_date'
        db.add_column('mybioregions_bioregionshapefile', 'bio_modification_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'BioregionShapefile.date_modified'
        db.add_column('mybioregions_bioregionshapefile', 'date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BioregionShapefile.bio_modification_date'
        db.delete_column('mybioregions_bioregionshapefile', 'bio_modification_date')

        # Deleting field 'BioregionShapefile.date_modified'
        db.delete_column('mybioregions_bioregionshapefile', 'date_modified')
