...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyBioregion.input_dwater_weight'
        db.add_column('mybioregions_mybioregion', 'input_dwater_weight', self.gf('django.db.models.fields.FloatField')(default=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MyBioregion.input_dwater_weight'
        db.delete_column('mybioregions_mybioregion', 'input_dwater_weight')
    ...
    models = {
        ...
        'mybioregions.mybioregion': {
            ...
            'input_dwater_weight': ('django.db.models.fields.FloatField', [], {}),
