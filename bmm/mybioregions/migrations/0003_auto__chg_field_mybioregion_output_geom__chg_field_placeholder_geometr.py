...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MyBioregion.output_geom'
        db.alter_column('mybioregions_mybioregion', 'output_geom', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=54009, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MyBioregion.output_geom'
        db.alter_column('mybioregions_mybioregion', 'output_geom', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
