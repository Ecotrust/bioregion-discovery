...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MyBioregion.input_starting_point'
        db.add_column('mybioregions_mybioregion', 'input_starting_point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True, srid=4326), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MyBioregion.input_start_point'
        db.add_column('mybioregions_mybioregion', 'input_start_point', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Deleting field 'MyBioregion.input_starting_point'
        db.delete_column('mybioregions_mybioregion', 'input_starting_point')
